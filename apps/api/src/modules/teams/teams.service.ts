...
export const listTeams = async (query: TeamsQuery): Promise<PaginatedResponse<TeamContract>> => {
...
export const getTeam = async (id: number): Promise<DetailResponse<TeamContract>> => {
