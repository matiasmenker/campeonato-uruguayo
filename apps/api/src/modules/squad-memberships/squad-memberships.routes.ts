...
squadMembershipsRouter.get("/api/v1/squad-memberships", async (request, response, next) => {
  try {
...
squadMembershipsRouter.get("/api/v1/squad-memberships/:id", async (request, response, next) => {
  try {
...
squadMembershipsRouter.get("/api/v1/teams/:id/squad", async (request, response, next) => {
  try {
