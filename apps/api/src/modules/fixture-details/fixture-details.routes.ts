...
fixtureDetailsRouter.get("/api/v1/fixture-change-logs", async (request, response, next) => {
  try {
...
fixtureDetailsRouter.get("/api/v1/fixtures/:id/change-logs", async (request, response, next) => {
  try {
...
fixtureDetailsRouter.get("/api/v1/events", async (request, response, next) => {
  try {
...
fixtureDetailsRouter.get("/api/v1/fixtures/:id/events", async (request, response, next) => {
  try {
    const { id } = fixtureIdParamSchema.parse(request.params);
    const query = eventsQuerySchema.parse(request.query);
...
fixtureDetailsRouter.get("/api/v1/lineups", async (request, response, next) => {
  try {
...
fixtureDetailsRouter.get("/api/v1/fixtures/:id/lineups", async (request, response, next) => {
  try {
    const { id } = fixtureIdParamSchema.parse(request.params);
    const query = lineupsQuerySchema.parse(request.query);
...
fixtureDetailsRouter.get("/api/v1/fixture-player-statistics", async (request, response, next) => {
  try {
...
fixtureDetailsRouter.get("/api/v1/fixture-team-statistics", async (request, response, next) => {
  try {
