            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-end justify-center gap-6">
                <div className="flex min-w-0 flex-1 flex-col items-end gap-2">
                  <div className="h-16 w-16 rounded-lg bg-slate-300/60" />
                  <div className="h-5 w-28 rounded bg-slate-300/60" />
                </div>
                <div className="flex shrink-0 flex-col items-center gap-2 pb-1">
                  <div className="h-12 w-28 rounded-lg bg-slate-300/60" />
              ...
              <div className="flex items-center justify-between gap-3">
                ...
                <div className="h-6 w-32 rounded-full bg-slate-300/60" />
              </div>
            </div>
          </div>
        </div>
